...
| 選舉類型 | 週期 | 支援年份 |
|----------|------|----------|
| **總統立委選舉** | 每 4 年 | 2016、2020、2024 |
| **地方公職人員選舉** | 每 4 年（與總統選舉錯開 2 年） | 2014、2018、2022 |
...
|----------|------|
| 總統選舉 | 全國 22 縣市總統選舉資料 |
| 區域立委選舉 | 區域立法委員選舉資料（73 選區） |
| 山地原住民立委選舉 | 山地原住民立法委員選舉資料（3 席） |
| 平地原住民立委選舉 | 平地原住民立法委員選舉資料（3 席） |
| 政黨票 | 不分區政黨票選舉資料（34 席） |

### 地方公職人員選舉（2014、2018、2022）
...
2016 年檔案使用特殊後綴命名（如 `elbase_P1.csv`）：
...
# 處理所有年份（2014、2016、2018、2020、2022、2024）
python main.py

# 只處理特定年份
python main.py --year 2014    # 2014 地方選舉
python main.py --year 2016    # 2016 總統立委
python main.py --year 2018    # 2018 地方選舉
python main.py --year 2020    # 2020 總統立委
python main.py --year 2022    # 2022 地方選舉
python main.py --year 2024    # 2024 總統立委
...
│   ├── 2014-103年地方公職人員選舉/  # 地方選舉
│   ├── 2016總統立委/                # 總統立委（特殊檔名格式）
│   ├── 2018-107年地方公職人員選舉/  # 地方選舉
│   ├── 2020總統立委/                # 總統立委
│   ├── 2022-111年地方公職人員選舉/  # 地方選舉（代碼式資料夾）
│   └── 2024總統立委/                # 總統立委
├── output/                          # 處理後輸出
│   ├── 臺北市/
│   ├── 花蓮縣/
...
- `ELECTION_TYPES_2014` - 2014 年地方選舉類型配置
- `ELECTION_TYPES_2016` - 2016 年總統立委選舉類型配置（含特殊檔名後綴處理）
- `ELECTION_TYPES_2018` - 2018 年地方選舉類型配置
- `ELECTION_TYPES_2020` - 2020 年總統立委選舉類型配置
- `ELECTION_TYPES_2022` - 2022 年地方選舉類型配置（使用代碼式資料夾）
- `ELECTION_TYPES_2024` - 2024 年總統立委選舉類型配置
...
- 版本：4.0.0
- 最後更新：2025-12-25
- 支援年份：2014、2016、2018、2020、2022、2024
- 支援選舉類型：
  - **地方選舉**（2014、2018、2022）：縣市長、縣市議員、鄉鎮市長
  - **總統立委選舉**（2016、2020、2024）：總統、區域立委、山地原住民立委、平地原住民立委、政黨票

## 版本歷史

### 4.0.0 (2025-12-25)

- **新增 2016、2018、2022、2024 年選舉資料處理**
  - 2016 總統立委選舉：支援特殊檔案命名格式（`_P1`、`_T1`、`_T2`、`_T3`、`_T4` 後綴）
  - 2018 地方公職人員選舉：與 2014 相同結構
  - 2022 地方公職人員選舉：支援代碼式資料夾結構（`C1`、`T1`、`D1`）
  - 2024 總統立委選舉：與 2020 相同結構
- 新增 `ELECTION_TYPES_2016`、`ELECTION_TYPES_2018`、`ELECTION_TYPES_2022`、`ELECTION_TYPES_2024` 配置
- 自動偵測 2016 年檔案後綴名
- 生成所有年份的全國選舉合併檔案（xlsx/csv）
- 資料正確性已與中選會官方資料比對驗證
